...
import com.isyara.app.data.remote.response.DataQuizById
...
class InGameViewModel(private val quizRepository: QuizRepository) : ViewModel() {
    ...
    private val _levelData = MutableLiveData<com.isyara.app.data.remote.response.DataQuizById?>()
    val levelData: LiveData<com.isyara.app.data.remote.response.DataQuizById?> get() = _levelData
